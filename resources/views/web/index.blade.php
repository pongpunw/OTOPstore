		...
		<div class="spec ">
			...
			<div class="tab-head ">
				<nav class="nav-sidebar">
					<ul class="nav tabs ">
					  <li class="active"><a href="#tab1" data-toggle="tab">ข้าวสาร สีใหม่</a></li>
					  <li class=""><a href="#tab2" data-toggle="tab">ผักสด สวนครัว</a></li> 
					  <li class=""><a href="#tab3" data-toggle="tab">ผลไม้ ตามฤดู</a></li>  
					  <li class=""><a href="#tab4" data-toggle="tab">สินค้าหัตถกรรม</a></li>
					</ul>
				</nav>
