...
<html>
<head>
<title>แหล่งรวมสินค้า โอทอป ออนไลน์ สำหรับคนไทย | เปิดร้านฟรี ขายฟรี  </title>
<!-- for-mobile-apps -->
...
<body>
<a href="offer.html"><img src="images/black_ribbon_top_left.png" class="img-head" alt=""></a>
<div class="header">

		<div class="container">
			
			<div class="logo">
				<h1 ><a href="index.html"><b>ไ<br>ท<br>ย</b>&nbsp;&nbsp;ร้านโอทอปสโตร์<span>www.OTOPstore.com</span></a></h1>
			</div>
			<div class="head-t">
				<ul class="card">
					<li><a href="wishlist.html" ><i class="fa fa-users" aria-hidden="true"></i>ขายสินค้าฟรี</a></li>
					<li><a href="wishlist.html" ><i class="fa fa-home" aria-hidden="true"></i>เปิดร้านค้าฟรี</a></li>
					<li><a href="wishlist.html" ><i class="fa fa-heart" aria-hidden="true"></i>อยากได้</a></li>
					<li><a href="login.html" ><i class="fa fa-user" aria-hidden="true"></i>เข้าสู่ระบบ</a></li>
					<li><a href="register.html" ><i class="fa fa-arrow-right" aria-hidden="true"></i>ลงทะเบียน</a></li>
					<li><a href="about.html" ><i class="fa fa-file-text-o" aria-hidden="true"></i>ประวัติสั่งซื้อ</a></li>
					<li><a href="shipping.html" ><i class="fa fa-ship" aria-hidden="true"></i>ช็อป</a></li>
				</ul>	
			</div>
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							<li class=" active"><a href="index.html" class="hyper "><span>หน้าห้าง</span></a></li>	
							
							<li class="dropdown ">
								<a href="#" class="dropdown-toggle  hyper" data-toggle="dropdown" ><span>อาหาร<b class="caret"></b></span></a>
								<ul class="dropdown-menu multi">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
			
												<li><a href="kitchen.html"><i class="fa fa-angle-right" aria-hidden="true"></i>อาหารกระป๋อง</a></li>
												<li><a href="kitchen.html"><i class="fa fa-angle-right" aria-hidden="true"></i>อาหารสำเร็จรูป</a></li>
												<li><a href="kitchen.html"> <i class="fa fa-angle-right" aria-hidden="true"></i>อาหารแปรรูป</a></li>
												<li><a href="kitchen.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ผลิตภัณฑ์จากข้าว</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="kitchen.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ซอส น้ำจิ้ม เครื่องปรุง</a></li>
												<li><a href="kitchen.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ผัก</a></li>
												<li><a href="kitchen.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ผลไม้</a></li>
												<li><a href="kitchen.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ขนมขบเคี้ยว</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="kitchen.html"><i class="fa fa-angle-right" aria-hidden="true"></i>อาหารอื่นๆ</a></li>
							...
							<li class="dropdown">
								...
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span>เครื่องดื่ม<b class="caret"></b></span></a>
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="care.html"><i class="fa fa-angle-right" aria-hidden="true"></i> น้ำผลไม้ พืช ผัก </a></li>
												<li><a href="care.html"><i class="fa fa-angle-right" aria-hidden="true"></i>เครื่องดืมสมุนไพร</a></li>
												<li><a href="care.html"><i class="fa fa-angle-right" aria-hidden="true"></i>เครื่องดื่มรังนก</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="care.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ชา กาแฟ</a></li>
												<li><a href="care.html"> <i class="fa fa-angle-right" aria-hidden="true"></i>น้ำแร่ </a></li>
												<li><a href="care.html"><i class="fa fa-angle-right" aria-hidden="true"></i>นม นมข้าว</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="care.html"><i class="fa fa-angle-right" aria-hidden="true"></i> ไวน์ </a></li>
												<li><a href="care.html"><i class="fa fa-angle-right" aria-hidden="true"></i>สุรา สุราแช่ สาโท</a></li>
												<li><a href="care.html"><i class="fa fa-angle-right" aria-hidden="true"></i>เครื่องดื่มอื่นๆ</a></li>
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span>ผ้า เครื่องแต่งกาย<b class="caret"></b></span></a>
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ผ้าไหม</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ผ้าฝ้าย</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ผ้าบาติก</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ผ้าอื่นๆ</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ชุดเสื้อสุภาพบุรษ</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ชุดเสื้อสุภาพสตรี</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>เสื้อผ้า</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>เสื้อผ้าเด็ก</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>รองเท้า</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>กระเป๋า</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>เครื่องหนัง</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ผ้าและเครื่องแต่งกายอื่นๆ </a></li>
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span>ของใช้ประดับ ตกแต่ง<b class="caret"></b></span></a>
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ผลิตภัณฑ์จากผ้า</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>เสื่อต่าง</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ดอกไม้ประดิษฐ์</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ตุ๊กตา</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>เทียนหอม</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>เฟอร์นิเจอร์</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>จักรสานต่างๆ</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ผลิตภัณฑ์ผักตบชวา</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>เครื่องเบญจรงค์</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>กระดาษ กระดาษสา</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ไม้เกาะสลัก</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>กะลามะพร้าว </a></li>
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span>สมุนไพร<b class="caret"></b></span></a>
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>สบู่</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>แชมพู</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ยาสีฟัน</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>สมุนไพร</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>สมุนไพร อื่นๆ</a></li>
							...
							<li><a href="codes.html" class="hyper"> <span>โค๊ด</span></a></li>
...
<div data-vide-bg="video/video">
    <div class="container">
		<div class="banner-info">
			<h3>ซื้อก็ง่าย ขายก็คล้อง โอทอปสโตร์ </h3>	
		...
		<div class="spec ">
			...
			<div class="tab-head ">
				<nav class="nav-sidebar">
					<ul class="nav tabs ">
					  <li class="active"><a href="#tab1" data-toggle="tab">ตุ๊กตุ๊กไทยแลนด์</a></li>
					  <li class=""><a href="#tab2" data-toggle="tab">แก้วเป่า</a></li> 
					  <li class=""><a href="#tab3" data-toggle="tab">ปฏิทิน กล่องนามบัตร</a></li>  
					  <li class=""><a href="#tab4" data-toggle="tab">แม่เหล็กติดตู้เย็น</a></li>
					</ul>
				</nav>
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">								
									<a href="#" data-toggle="modal" data-target="#myModal1" class="offer-img">
										<img src="images/tuktuk01.png" class="img-responsive" alt="">
										<div class="offer"><p><span>รายละเอียด 3D</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">โมเดลรถตุ๊กตุ๊ก</a>(พรีเมี่ยม)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>฿250.00</label><em class="item_price">฿199.00</em></p>
											  <div class="block">
										...
										<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b " data-id="1" data-name="โมเดลตุ๊กตุ๊ก (พรีเมียม)" data-summary="summary 1" data-price="199.00" data-quantity="1" data-image="images/tuktuk01.png">หยิบใส่ตะกร้า</button>
										</div>
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal2" class="offer-img">
										<img src="images/tuktuk02.png" class="img-responsive" alt="">
										<div class="offer"><p><span>รายละเอียด 3D</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">โมเดลรถตุ๊กตุ๊ก</a>(ทำสี)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>฿600.00</label><em class="item_price">฿550.00</em></p>
											  <div class="block">
												<div class="starbox small ghosting"> </div>
											</div>
											<div class="clearfix"></div>
												...
												<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="2" data-name="โมเดลตุ๊กตุ๊ก (ทำสี)" data-summary="summary 2" data-price="550.00" data-quantity="1" data-image="images/tuktuk02.png">หยิบใส่ตะกร้า</button>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal3" class="offer-img">
										<img src="images/tuktuk03.png" class="img-responsive" alt="">
										<div class="offer"><p><span>รายละเอียด 3D</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">โมเดลรถตุ๊กตุ๊ก</a>(หลากสี)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>฿250.00</label><em class="item_price">฿199.00</em></p>
											  <div class="block">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="3" data-name="โมเดลตุ๊กตุ๊ก (หลากสี)" data-summary="summary 3" data-price="199.00" data-quantity="1" data-image="images/tuktuk03.png">หยิบใส่ตะกร้า</button>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal4" class="offer-img">
										<img src="images/tuktuk04.png" class="img-responsive" alt="">
										<div class="offer"><p><span>รายละเอียด 3D</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">โมเดลตุ๊กตุ๊ก</a>(ขดลวด)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>฿250.00</label><em class="item_price">฿199.00</em></p>
											  <div class="block">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="4" data-name="โมเดลตุ๊กตุ๊ก (ขดลวด)" data-summary="summary 4" data-price="199.00" data-quantity="1" data-image="images/tuktuk04.png">หยิบใส่ตะกร้า</button>
										</div>
									</div>
								</div>
							</div>
...
<div class="content-mid">
	<div class="container">
		...
		<div class="col-md-4 m-w3ls">
			<div class="col-md1 ">
				<a href="kitchen.html">
					<img src="images/tk1.png" class="img-responsive img" alt="">
					<div class="big-sa">
						<h6>รวมโมเดลรถ</h6>
						<h3>ตุ๊กตุ๊ก<span>ไทยแลนด์ </span></h3>
						<p>ไม่มีนักท่องเที่ยวต่างชาติ ชาติใดไม่รู้จัก ตุ๊กตุ๊กไทยแลนด์ </p>
					</div>
				</a>
			</div>
		</div>
		<div class="col-md-4 m-w3ls1">
			<div class="col-md ">
				<a href="hold.html">
					<img src="images/co.png" class="img-responsive img" alt="">
					<div class="big-sale">
						<div class="big-sale1">
							<h3>ของกิน <span>ไทย</span></h3>
							<p>ผัก ผลไม้ ไทย ไม่แพ้ใครในโลก </p>
						</div>
					</div>
				</a>
			</div>
		...
		<div class="col-md-4 m-w3ls">
			<div class="col-md2 ">
				<a href="kitchen.html">
					...
					<div class="big-sale2">
						<h3>โอทอป<span>ไทย</span></h3>
						<p>ขับเคลือนสินค้า โอทอปไทย ทั่วถึงไทย ไกลทั่วโลก</p>		
					</div>
				</a>
			</div>
			<div class="col-md3 ">
				<a href="hold.html">
					...
					<div class="big-sale3">
						<h3>ไทยช่วย<span>ไทย</span></h3>
						<p>เราจะเติบโต ก้าวไกล อย่างมั่นใจ มั่นคง มั่งคั้ง ยั้งยืน</p>
					</div>
				</a>
			</div>
		</div>
...
<!-- Carousel
	...
	<div class="product">
		<div class="container">
			<div class="spec ">
				<h3>สมุนไพร ผลิตภัณฑ์ธรรมชาติ</h3>
				<div class="ser-t">
					<b></b>
					<span><i></i></span>
					<b class="line"></b>
...
<div class="footer">
	<div class="container">
		<div class="col-md-3 footer-grid">
			<h3>เกี่ยวกับเรา</h3>
			<p>แหล่งรวมสินค้าโอทอป ผู้ผลิต ผู้ขาย ระดับย่อย ชุมชนและอุตสาหกรรม ซื้อง่าย ขายคล่อง โอทอปสโตร์</p>
		</div>
		<div class="col-md-3 footer-grid ">
			<h3>เมนู</h3>
			<ul>
				<li><a href="index.html">หน้าห้าง</a></li>
				<li><a href="kitchen.html">อาหาร</a></li>
				<li><a href="care.html">เครื่องดื่ม</a></li>
				<li><a href="hold.html">ผ้า เครื่องแต่งกาย</a></li>	
				<li><a href="hold.html">ของใช้ประดับตกแต่ง</a></li>
				<li><a href="hold.html">สมุนไพร</a></li>					 
				<li><a href="codes.html">โค๊ด</a></li> 
		...
		<div class="col-md-3 footer-grid ">
			<h3>บริการลูกค้า</h3>
			<ul>
				<li><a href="shipping.html">การซื้อสินค้า</a></li>
				<li><a href="terms.html">ระเบียบข้อตกลง</a></li>
				<li><a href="faqs.html">คำถามที่พบบ่อย</a></li>
				<li><a href="contact.html">ติตต่อเรา</a></li>
				<li><a href="offer.html">สินค้าออนไลน์</a></li>						 
		...
		<div class="col-md-3 footer-grid">
			...
			<ul>
				...
				<li><a href="wishlist.html">สินค้าที่คุณเลือกไว้</a></li>
				
			</ul>
		</div>
		<div class="clearfix"></div>
			<div class="footer-bottom">
				<h2 ><a href="index.html"><b>ไ<br>ท<br>ย</b>&nbsp;&nbsp;ร้านโอทอปสโตร์<span>www.OTOPstore.com</span></a></h2>
				<p class="fo-para">ห้างสรรพสินค้า ออนไลน์ ของชุมชนไทย แหล่งรวมผู้ผลิต ผู้ขายสินค้า โอทอป ทั่วประเทศไทย </p>
				<ul class="social-fo">
				...
				<div class=" address">
					<div class="col-md-4 fo-grid1">
							<p><i class="fa fa-home" aria-hidden="true"></i> 838/71 เดอะทรอป แขวงทับยาว เขตลาดกระบัง กทม.</p>
					</div>
					<div class="col-md-4 fo-grid1">
							<p><i class="fa fa-phone" aria-hidden="true"></i>+6689 126 3688 , +6689 176 6962</p>	
					</div>
					<div class="col-md-4 fo-grid1">
						<p><a href="mailto:info@example.com"><i class="fa fa-envelope-o" aria-hidden="true"></i>sale@otopstore.com</a></p>
					</div>
					<div class="clearfix"></div>
		...
		<div class="copy-right">
			<p> &copy; 2016 OTOP store. All Rights Reserved | Design by  <a href="http://www.otopstore.com/"> W3layouts</a></p>
		</div>
	</div>
</div>
<!-- //footer-->
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									<h3>โมเดลตุ๊กตุ๊ก พรีเมี่ยม</h3>
									<p class="in-para">โมเดลตุ๊กตุ๊ก ขนาดกลาง (M) พรีเมี่ยม </p>
									<div class="price_single">
									  <span class="reducedfrom "><del>฿250.00</del>฿199.00</span>
									
									 <div class="clearfix"></div>
									</div>
									<h4 class="quick">คุณสมบัติสินค้า</h4>
									<p class="quick_desc">สัญลักษณ์ประเทศไทยที่ชาวฝรั่งรู้จัก Tuk-tuk Thailand ขณะนี้ www.OTOPstore.com ขาย  199 บาท / คัน ไม่รวมค่าส่ง สีสวยสัดส่วนเสมือนจริง เหมาะให้เป็นของขวัญที่ระลึกค่ะ สินค้าทุกชิ้นส่งถึงมือลูกค้าด้วยความมั่นใจ น้ำหนัก  120 กรัม กว้าง 6.5 เซนติเมตร ยาว 16 เซนติเมตร สูง 11 เซนติเมตร</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="1" data-name="โมเดลตุ๊กตุ๊ก (พรีเมี่ยม)" data-summary="summary 1" data-price="199.00" data-quantity="1" data-image="images/tuktuk01.png">หยิบใส่ตะกร้า</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									<h3>โมเดลตุ๊กตุ๊ก (ทำสี)</h3>
									<p class="in-para">โมเดลตุ๊กตุ๊ก ทำสีเหมือนจริง</p>
									<div class="price_single">
									  <span class="reducedfrom "><del>฿600.00</del>฿550.00</span>									
									 <div class="clearfix"></div>
									</div>
									<h4 class="quick">คุณสมบัติสินค้า</h4>
									<p class="quick_desc"> อีกหนึ่ง ผลิตภัณฑ์ที่ ร้านโอทอปสโตร์ นำเสนอด้วยจากการ Remake ตุ๊กๆ ขนาดจัมโบ แต่งแต้มสีสันสวยงาม เหมือนตุ๊กๆไทยแลนด์ ด้วยสีน้ำเงินแดง ในราคา 550 บาท ราคาพิเศษ นี้พร้อมจัดส่ง EMS ค่ะ ด้วยน้ำหนัก 0.8 Kg. ขนาด 19 x 20.5 x 15.5 cm. </p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="2" data-name="โมเดลตุ๊กตุ๊ก (ทำสี)" data-summary="summary 2" data-price="550.00" data-quantity="1" data-image="images/tuktuk02.png">หยิบใส่ตะกร้า</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									<h3>โมเดลตุ๊กตุ๊ก (หลากสี)</h3>
									<p class="in-para">โมเดลตุ๊กตุ๊ก หลากสี</p>
									<div class="price_single">
									  <span class="reducedfrom "><del>฿250.00</del>฿199.00</span>
									...
									<h4 class="quick">คุณสมบัติสินค้า</h4>
									<p class="quick_desc">โมเดลตุ๊กๆ ขนาดกลาง สีสดสวย ในราคา 250 บาท (ไม่รวมค่าขนส่งทาง EMS ) น้ำหนัก  120 กรัม กว้าง 6.5 เซนติเมตร ยาว 16 เซนติเมตร สูง 11 เซนติเมตร</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="3" data-name="โมเดลตุ๊กตุ๊ก (หลากสี)" data-summary="summary 3" data-price="199.00" data-quantity="1" data-image="images/tuktuk03.png">หยิบใส่ตะกร้า</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									<h3>โมเดลตุ๊กตุ๊ก (ขดลวด)</h3>
									<p class="in-para">โมเดลตุ๊กตุ๊ก ขดลวด งานทำมือสวยงามและเป็นหนึ่งเดียว</p>
									<div class="price_single">
									  <span class="reducedfrom "><del>฿250.00</del>฿199.00</span>
									...
									<h4 class="quick">คุณสมบัติสินค้า</h4>
									<p class="quick_desc"> โมเดลตุ๊กๆ อีกรูปแบบที่ ร้านโอทอปสโตร์ นำเสนอ ศิลปะทำมือ สวยงามเล่นลวดลาย สีสันเหมาะเป็นของฝากชำรวย ด้วยราคา 199 บาท น้ำหนักเพียง 80 กรัม ขนาด 7.2 x 14 x 9 cm. มีให้เลือก 3 สี 3 ลวดลาย ค่ะ  ทั้งนี้ไม่รวมราคาส่ง EMS</p>
									 <div class="add-to">
								
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="4" data-name="โมเดลตุ๊กตุ๊ก (ขดลวด)" data-summary="summary 4" data-price="199.00" data-quantity="1" data-image="images/tuktuk04.png">หยิบใส่ตะกร้า</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
